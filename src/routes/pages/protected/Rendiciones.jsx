...
export const Rendicones = () => {
  ...
  const currentResults = rendicionesMensuales?.slice(
    indexOfFirstItem,
    indexOfLastItem
  );

  const totalPages = Math.ceil(rendicionesMensuales?.length / itemsPerPage);
  ...
  const uniqueUsers = Array.from(
    new Set(rendicionesMensuales.map((salida) => salida.usuario.toLowerCase()))
  );
