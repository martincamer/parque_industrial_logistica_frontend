...
export const ModalCrearClienteEditar = ({ setDatosCliente, datosCliente }) => {
  ...
  const handleCliente = () => {
    ...
    document.getElementById("my_modal_crear_cliente_editar").close();
  };
  return (
    <dialog id="my_modal_crear_cliente_editar" className="modal">
