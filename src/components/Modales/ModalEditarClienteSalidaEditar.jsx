...
export const ModalEditarClienteSalidaEditar = ({
  setDatosCliente,
  datosCliente,
  usuario,
}) => {
  ...
  const handleCliente = () => {
    ...
    document.getElementById("my_modal_editar_cliente_editar").close();
  };
  return (
    <dialog id="my_modal_editar_cliente_editar" className="modal ">
