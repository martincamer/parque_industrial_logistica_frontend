...
export const ModalCrearUsuarioNuevo = ({ isOpen, closeModal, obtenerId }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = handleSubmit(async (data) => {
    await client.put(`/users-password/${obtenerId}`, data);

    toast.success("¡Contraseña cambiada correctamente, espera 5 segundos!", {
      position: "top-center",
      autoClose: 1500,
                ...
                >
                  <div className="flex flex-col gap-2 max-md:text-sm">
                    ...
                    <input
                      ...
                      type="text"
                      className="text-slate-700 bg-white rounded-xl py-2.5 px-2 border-slate-300 border-[1px] text-sm"
                    />
                  </div>
