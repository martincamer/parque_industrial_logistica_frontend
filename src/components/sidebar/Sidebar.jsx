    ...
    <>
      ...
      >
        <div
          ...
          className="fixed left-0 top-0 z-[100] h-full w-5 bg-gray-100/50"
        ></div>
      </div>
      <div
        ref={menuRef}
            ...
            <div>
              <div className="px-2">
                <ul className="space-y-1 flex flex-col pt-4">
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Salidas/Crear/Editar/Ver"
                  >
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Remuneraciones/Crear/Editar/Ver"
                  >
                    <Link
                      to={"/remuneraciones"}
                      onClick={() => toggleSidebar()}
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Legales/Crear/Editar/Ver"
                  >
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Rendiciones/Crear/Editar/Ver"
                  >
                  ...
                  <div
                    className="tooltip tooltip-right"
                    data-tip="Estadistica/filtrar/datos/etc"
                  >
                  ...
                  {user.localidad === "admin" && (
                    <Link to={"/cuentas"} onClick={() => toggleSidebar()}>
                      <a
                        href="#"
                        className={`${
